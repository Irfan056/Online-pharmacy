            ...
            <div>
                <Row>
                    <Col className="card ms-3 me-3 px-3 py-3">
                        <h6 className="fw-bolder text-primary">EMERGENCY CASE</h6>
                        <div>--------------------</div>
                    ...
                    <Col className="card ms-3 me-3 px-3 py-3">
                        <h6 className="fw-bolder text-primary">24 Hours Service</h6>
                        <div>----------------------</div>
                    ...
                    <Col className="card ms-3 me-3 px-3 py-3">
                        <h6 className="fw-bolder text-primary">Opening Hours</h6>
                        <div>-------------------</div>
                        <p>24 hours open</p>
                        <Button>Read More</Button>
